{
  ...
  outputs =
    ...
    in
    {
      ...
      packages.${system} = pkgs.haskellPackages.appendfulPackages;
      checks.${system} =
        let
          backwardCompatibilityCheckFor = nixpkgs:
            let pkgs' = pkgsFor nixpkgs;
            in pkgs'.haskellPackages.appendfulRelease;
          allNixpkgs = {
            inherit
              nixpkgs-22_11
              nixpkgs-22_05
        ...
        backwardCompatibilityChecks // {
          forwardCompatibility = horizonPkgs.haskellPackages.appendfulRelease;
          release = pkgs.haskellPackages.appendfulRelease;
      ...
      devShells.${system}.default = pkgs.haskellPackages.shellFor {
        ...
        packages = (p:
          (builtins.attrValues p.appendfulPackages)
        );
        withHoogle = true;
        doBenchmark = true;
